...
HD_PWD='/home/aaron/Project/P35_exercise4/Large_matrix_mult_IP/Large_matrix_mult_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Large_Matrix_Mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Large_Matrix_Mult.tcl
