proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: large_mult_full_0, and set properties
	set large_mult_full_0 [ create_bd_cell -type ip -vlnv user.org:user:large_mult_full:1.0 large_mult_full_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI] [get_bd_intf_pins large_mult_full_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_ACLK] [get_bd_pins large_mult_full_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_ARESETN] [get_bd_pins large_mult_full_0/S00_AXI_ARESETN]
	...
	# Create interface connections
	connect_bd_intf_net [get_bd_intf_pins master_1/M_AXI_LITE] [get_bd_intf_pins large_mult_full_0/S_AXI_INTR]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_1/M_AXI_LITE_ACLK] [get_bd_pins large_mult_full_0/S_AXI_INTR_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_1/M_AXI_LITE_ARESETN] [get_bd_pins large_mult_full_0/S_AXI_INTR_ARESETN]
	set S_AXI_INTR_IRQ [ create_bd_port -dir O -type intr irq ]
	connect_bd_net [get_bd_pins /large_mult_full_0/irq] ${S_AXI_INTR_IRQ}
	...
	set offset_file "${bd_path}/large_mult_full_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef large_mult_full_v1_0_tb_include_vh_"
	puts $fp "`define large_mult_full_v1_0_tb_include_vh_\n"
	...
	set param_irq_active_state [get_property CONFIG.C_IRQ_ACTIVE_STATE [get_bd_cells large_mult_full_0]]
	set param_irq_sensitivity [get_property CONFIG.C_IRQ_SENSITIVITY [get_bd_cells large_mult_full_0]]
	set param_intr_active_state [get_property CONFIG.C_INTR_ACTIVE_STATE [get_bd_cells large_mult_full_0]]
	set param_intr_sensitivity [get_property CONFIG.C_INTR_SENSITIVITY [get_bd_cells large_mult_full_0]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:large_mult_full:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/large_mult_full_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "large_mult_full_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 large_mult_full_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top large_mult_full_v1_0_tb [get_filesets sim_1]
